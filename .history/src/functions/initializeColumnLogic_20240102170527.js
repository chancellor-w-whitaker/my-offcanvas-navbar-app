...
export const initializeColumnLogic = (rowData) => {
  ...
  // ! outside of this file (& hook), for compatibility with groupBy function, for each row, add row[row[pivotColumn]] = row[measure] (make sure to deep copy rows to prevent awkwardmess)
  //
