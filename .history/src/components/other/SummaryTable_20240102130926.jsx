...
export const SummaryTable = () => {
  ...
  return (
    <>
      <div
        className="d-flex flex-wrap flex-lg-nowrap gap-3"
        style={{ height: 500 }}
      >
        <div className="overflow-auto d-flex flex-row flex-lg-column justify-content-start gap-3 flex-wrap rounded shadow-sm p-3 mb-auto">
          <Tabs
