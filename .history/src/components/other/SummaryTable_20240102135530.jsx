  ...
  return (
    <>
      <div className="d-flex flex-wrap flex-lg-nowrap gap-3 align-items-stretch">
        <div className="d-flex flex-row flex-lg-column gap-3 flex-wrap rounded shadow-sm p-3 mb-auto w-100 w-lg-auto">
          <Tabs
        ...
        <div
          className="ag-theme-quartz w-100 flex-shrink-0"
          style={{ minHeight: 500 }}
        >
          <Grid
