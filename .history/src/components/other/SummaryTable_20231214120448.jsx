...
const getEachColTypeOccurrences = (rowData) => {
...
export const SummaryTable = () => {
  ...
  const columns = useMemo(() => {
    ...
    const defs = Object.entries(eachColTypeOccurrences).map(
      ([field, thisColTypeOccurrences]) => ({
        type: findMostCommonType(thisColTypeOccurrences),
        field,
      })
    );
