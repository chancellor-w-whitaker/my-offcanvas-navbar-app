export const MainContainer = () => {
  return (
    <main className="container">
      <div className="d-flex align-items-center p-3 my-3 text-white bg-purple rounded shadow-sm bg-gradient">
        <img
          src="https://getbootstrap.com/docs/5.3/assets/brand/bootstrap-logo-white.svg"
          className="me-3"
          height={38}
          width={48}
          alt=""
